    ...
    <section className="py-24 bg-[#030712] relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 relative z-10">
        <div className="text-center mb-16">
          ...
          >
            {data?.heading ? (
              <span dangerouslySetInnerHTML={{ __html: data.heading.replace('profissionais.', '<span class="text-transparent bg-clip-text bg-gradient-to-r from-emerald-400 to-cyan-400">profissionais.</span>') }} />
            ) : (
          ...
          >
            {data?.subtitle || 'Veja o que dizem os motoristas que trocaram as taxas abusivas pela parceria justa do Bora Passageiro.'}
          </motion.p>
        </div>
