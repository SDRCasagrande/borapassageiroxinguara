...
export const motoristaDefaults: Record<string, any> = {
  hero: {
    ...
    subtitle: 'No Bora Passageiro, trabalhamos com planos com taxas justas a partir de 10%. Entre em contato com a gente para mais detalhes. Quanto mais você roda, mais lucro de verdade fica no seu bolso.',
    taxRate: '10%',
    ...
    floatingBadges: [
      ...
      { label: 'Taxa Bora', value: 'A partir de 10%' },
    ],
  },
  fintech: {
    ...
    rows: [
      ...
      { label: 'Taxa Bora', subLabel: 'Taxas a partir de 10% do faturamento', value: '- R$ 34,00', color: 'rose' },
  ...
  calculator: {
    ...
    subtitle: 'Sem taxas ocultas, sem letras miúdas. Simule os ganhos com base na nossa taxa a partir de 10%.',
    averageTicket: 15,
    feePercent: 10,
    workingDays: 25,
    sliderMin: 5,
  ...
  faq: {
    ...
    items: [
      { question: 'Como funciona a taxa do Bora Passageiro?', answer: 'Trabalhamos com taxas justas a partir de 10%. Entre em contato com a nossa equipe para conhecer os planos detalhados.' },
