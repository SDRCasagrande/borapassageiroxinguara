...
export const motoristaDefaults: Record<string, any> = {
  hero: {
    ...
    subtitle: 'O Bora Passageiro cobra apenas 10% de taxa fixa. Nada de surpresas. Quanto mais você roda, mais lucro de verdade fica no seu bolso.',
    taxRate: '10%',
    ...
    floatingBadges: [
      ...
      { label: 'Taxa Bora', value: 'Apenas 10%' },
    ],
  },
  fintech: {
    ...
    rows: [
      ...
      { label: 'Taxa Bora', subLabel: 'Apenas 10% do faturamento', value: '- R$ 34,00', color: 'rose' },
      { label: 'Líquido no Bolso', subLabel: 'Seu dinheiro de verdade', value: 'R$ 306,00', color: 'emerald' },
    ],
  ...
  calculator: {
    ...
    subtitle: 'Sem taxas ocultas, sem letras miúdas. Calcule exatamente quanto vai para o seu bolso com a nossa taxa fixa de 10%.',
    averageTicket: 15,
    feePercent: 10,
    workingDays: 25,
    sliderMin: 5,
  ...
  faq: {
    ...
    items: [
      { question: 'Como funciona a taxa do Bora Passageiro?', answer: 'Trabalhamos com a melhor taxa do mercado: 90% do valor da corrida fica com você. Nós ficamos com apenas 10% para manutenção do app e marketing. Sem taxas ocultas, sem surpresas.' },
      ...
      { question: 'Como recebo o pagamento das corridas?', answer: 'Corridas pagas em dinheiro ou PIX direto com você, o valor fica 100% na sua mão na hora (a taxa de 10% será descontada do seu saldo no app). Corridas no cartão no app caem na sua conta bancária semanalmente.' },
  ...
  cta: {
    quote: 'Eu rodava em outro app e ficava com menos de 70% do faturamento. No Bora, fico com 90% de tudo. Minha renda aumentou sem precisar trabalhar mais horas. É o app que realmente valoriza o motorista.',
